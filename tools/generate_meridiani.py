...
CHIAVE = {
  ...
  "VC8":  ("", "centro dell'ombelico (non si punge) — 5 cun sopra il pube, 8 sotto l'apofisi xifoidea"),
  ...
  "VC17": ("Mu del Maestro del Cuore · mare del Qi", "centro dello sterno, sulla linea dei capezzoli (4° spazio intercostale)"),
  ...
  "VG4":  ("porta della vita (Mingmen)", "sotto l'apofisi di L2, all'altezza dell'ultima costa"),
...
mer(id="milza", nome="Milza / Pancreas", sigla="MP", siglaInt="SP", elemento="Terra",
    ...
    seq=[
      ...
      A(14,"Fujie",   F(0.256,1.115)),
      A(15,"Daheng",  F(0.256,1.200)),
      A(16,"Fuai",    F(0.262,1.340)),
...
mer(id="rene", nome="Rene", sigla="R", siglaInt="KI", elemento="Acqua",
    ...
    seq=[
      ...
      W((0.16,0.10,-0.05)),
      W((0.07,0.82,0.185)),
      A(11,"Henggu",  F(0.07,0.888)),
      A(12,"Dahe",    F(0.07,0.944)),
      A(13,"Qixue",   F(0.07,1.008)),
      A(14,"Siman",   F(0.07,1.072)),
      A(15,"Zhongzhu",F(0.07,1.136)),
      A(16,"Huangshu",F(0.08,1.200)),
      A(17,"Shangqu", F(0.08,1.295)),
      A(18,"Shiguan", F(0.08,1.343)),
      A(19,"Yindu",   F(0.08,1.390)),
      A(20,"Futonggu",F(0.08,1.438)),
      A(21,"Youmen",  F(0.08,1.485)),
...
mer(id="vaso-concezione", nome="Vaso Concezione", sigla="VC", siglaInt="CV",
    ...
    seq=[
      ...
      A(2,"Qugu",     F(0.0,0.88)),
      A(3,"Zhongji",  F(0.0,0.944)),
      A(4,"Guanyuan", F(0.0,1.008)),
      A(5,"Shimen",   F(0.0,1.072)),
      A(6,"Qihai",    F(0.0,1.104)),
      A(7,"Yinjiao",  F(0.0,1.136)),
      A(8,"Shenque",  F(0.0,1.200)),
      A(9,"Shuifen",  F(0.0,1.248)),
      A(10,"Xiawan",  F(0.0,1.295)),
      A(11,"Jianli",  F(0.0,1.343)),
      A(12,"Zhongwan",F(0.0,1.390)),
      A(13,"Shangwan",F(0.0,1.438)),
      A(14,"Juque",   F(0.0,1.485)),
      A(15,"Jiuwei",  F(0.0,1.533)),
      A(16,"Zhongting",F(0.0,1.630)),
      A(17,"Shanzhong",F(0.0,1.800)),
      A(18,"Yutang",  F(0.0,1.880)),
      A(19,"Zigong",  F(0.0,1.950)),
      A(20,"Huagai",  F(0.0,2.015)),
      A(21,"Xuanji",  F(0.0,2.075)),
...
def dettagli_fronte():
    ...
    # retto dell'addome: 4 coppie di fasci (8 in tutto)
    for s in (1, -1):
        A([(s*0.078, 1.560), (s*0.078, 1.065)])
    for y in (1.440, 1.320, 1.200):
        A([(-0.078, y), (0.078, y)])
    D.append(_arco(0.0, 1.200, 0.028, 0.028, 0, 2*math.pi))                  # ombelico
